  ...
  const helpSections = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'Toggle the "Agent Mode" switch in the chat interface. This changes the system prompt to "Action-Oriented", enabling the Planner to decompose tasks and the Navigator to interact with the browser DOM.'
        }
      ]
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'The agent "sees" the webpage by analyzing the DOM tree and capturing screenshots. It uses computer vision to identify interactive elements, ensuring resilience against dynamic layout changes.'
        },
        {
          question: 'Files & RAG',
          answer: 'Upload PDFs, Code, or Text files. The "Files Analyzer" indexes content into vector embeddings, allowing you to "chat" with your documents and extract precise information.'
        }
      ]
    },
    {
      ...
      items: [
        {
          question: 'Local-First Data Storage',
          answer: 'Your data stays with you. Conversation history, vector embeddings, and preferences are stored in `chrome.storage.local` and IndexedDB within your browser instance. No external cloud sync is used.'
        },
        {
          question: 'API Cost & Security',
          answer: 'You control the costs. You bring your own API keys. We implement client-side encryption for key storage. Usage depends entirely on your interaction frequency and model choice (e.g., GPT-4o vs Flash).'
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          question: 'Agent Getting Stuck / Loop',
          answer: 'If the Navigator loops on a step using "Retry logic", it means the DOM element is not found or interactions are blocked. Try: 1. Refreshing the page. 2. Using a specific, simpler prompt. 3. Checking "Allow DOM Access" in site settings.'
        },
        {
          question: 'API Connection Errors',
          answer: 'Ensure your API key has quota remaining. Check the "Network" tab in DevTools for 401/429 errors. Using a proxy or VPN may sometimes interfere with direct API calls to providers.'
        },
        {
          question: 'Extension Permissions',
          answer: 'If features like "Screenshot" or "Tab Management" fail, verify that you have granted the necessary "Optional Permissions" in the Chrome extension details page.'
        }
      ]
    }
  ];
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs md:text-sm text-muted-foreground">
                Find answers to common questions, learn about features, and get support. Verified by Manoj Kumar.
              </p>
            </div>
          </div>
        </div>
